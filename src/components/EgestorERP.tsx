...
const EgestorERP = () => {
  ...
  const egestorLink = "https://www.egestor.com.br/afl/10259";
    ...
    <section className="py-16 bg-background overflow-hidden">
      <div className="container px-4 mx-auto max-w-6xl">
        ...
        <div className="flex justify-center animate-fade-in">
          <Button asChild className="w-full max-w-sm bg-accent hover:bg-accent/90 text-accent-foreground font-medium rounded-full shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200">
